...
# ========================================================================
# SUPPORTED OPERATING SYSTEMS - 34 TOTAL
# ========================================================================
#
# All Available Operating Systems:
#
# === Alpine Linux (4) ===
#   1. Alpine Linux 3.23.1 - Latest version
#   2. Alpine Linux Latest (3.21) - Latest stable
#   3. Alpine Linux 3.21
#   4. Alpine Linux 3.20
#
# === Ubuntu (5) ===
...
#   27. Gentoo Linux - OpenStack cloud image
#
# === Oracle Linux (2) ===
#   28. Oracle Linux 9 - ISO format
#   29. Oracle Linux 8 - ISO format
#
# === BSD Systems (3) ===
#   30. FreeBSD 15
#   31. OpenBSD 7.8
...
#
# === Windows (2) ===
#   33. Windows 11 - Docker-based
#   34. Windows 10 - Docker-based
#
# ========================================================================
...
declare -A OS_OPTIONS=(
    # === Alpine Linux ===
    ["Alpine Linux 3.23.1"]="alpine|3.23|https://dl-cdn.alpinelinux.org/alpine/v3.23/releases/cloud/nocloud_alpine-3.23.1-x86_64-bios-cloudinit-r0.qcow2|alpine323|alpine|alpine"
    ["Alpine Linux Latest (3.21)"]="alpine|latest|https://dl-cdn.alpinelinux.org/alpine/latest-stable/releases/cloud/nocloud_alpine-3.21.3-x86_64-bios-cloudinit-r0.qcow2|alpine-latest|alpine|alpine"
