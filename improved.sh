...
declare -A OS_OPTIONS=(
    ...
    ["Kali Linux 2024"]="kali|2024|kali|https://cdimage.kali.org/kali-2024.4/kali-linux-2024.4-qemu-amd64.7z|kali2024|kali|kali"
    ["Parrot OS 6.2 (Lorikeet)"]="parrot|6.2|lorikeet|https://deb.parrot.sh/parrot/iso/6.2/Parrot-security-6.2_amd64.iso|parrot62|parrot|parrot"
    ["MX Linux 23 (Libretto)"]="mxlinux|23|libretto|https://sourceforge.net/projects/mx-linux/files/Final/MX-23.4/MX-23.4_x64.iso/download|mxlinux23|mx|mxlinux"
    ["Linux Mint 22 (Wilma)"]="mint|22|wilma|https://mirrors.edge.kernel.org/linuxmint/stable/22/linuxmint-22-cinnamon-64bit.iso|mint22|mint|mint"
    ["Linux Mint 21.3 (Virginia)"]="mint|21.3|virginia|https://mirrors.edge.kernel.org/linuxmint/stable/21.3/linuxmint-21.3-cinnamon-64bit.iso|mint213|mint|mint"
    ["Deepin 23"]="deepin|23|beige|https://cdimage.deepin.com/releases/23/deepin-desktop-community-23-amd64.iso|deepin23|deepin|deepin"
    ...
    ["elementary OS 7.1 (Horus)"]="elementary|7.1|horus|https://cloud-images.ubuntu.com/jammy/current/jammy-server-cloudimg-amd64.img|elementary71|elementary|elementary"
    ...
    ["Devuan 5 (Daedalus)"]="devuan|5|daedalus|https://files.devuan.org/devuan_daedalus/virtual/devuan_daedalus_5.0.1_amd64_qemu.qcow2|devuan5|devuan|devuan"
