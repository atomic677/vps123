...
declare -A OS_OPTIONS=(
    ...
    ["MX Linux 23 (Libretto)"]="mxlinux|23|libretto|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|mxlinux23|mx|mxlinux"
    ["Kali Linux Rolling"]="kali|2024|kali|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|kali2024|kali|kali"
    ["Parrot OS 6.2"]="parrot|6.2|lorikeet|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|parrot62|parrot|parrot"
    ["Pop!_OS 22.04 LTS"]="popos|22.04|jammy|https://cloud-images.ubuntu.com/jammy/current/jammy-server-cloudimg-amd64.img|popos22|pop|popos"
    ["elementary OS 7.1"]="elementary|7.1|horus|https://cloud-images.ubuntu.com/jammy/current/jammy-server-cloudimg-amd64.img|elementary71|elementary|elementary"
    ["Deepin 23"]="deepin|23|beige|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|deepin23|deepin|deepin"
    ["Raspberry Pi OS (Debian 12)"]="raspios|12|bookworm|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|raspios12|pi|raspberry"
    ["Devuan 5 (Daedalus)"]="devuan|5|daedalus|https://cloud.debian.org/images/cloud/bookworm/latest/debian-12-generic-amd64.qcow2|devuan5|devuan|devuan"
