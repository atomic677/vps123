...
declare -A OS_OPTIONS=(
    # ==========================================
    # Ubuntu - All Versions (Official Cloud Images)
    ...
    ["Ubuntu 23.04 (Lunar)"]="ubuntu|23.04|lunar|https://cloud-images.ubuntu.com/lunar/current/lunar-server-cloudimg-amd64.img|ubuntu2304|ubuntu|ubuntu"
    ["Ubuntu 23.10 (Mantic)"]="ubuntu|23.10|mantic|https://cloud-images.ubuntu.com/mantic/current/mantic-server-cloudimg-amd64.img|ubuntu2310|ubuntu|ubuntu"
    ...
    # ==========================================
    ["Kali Linux 2024.3"]="kali|2024.3|kali2024|https://kali.download/cloud-images/kali-2024.3/kali-linux-2024.3-cloud-genericcloud-amd64.tar.xz|kali|kali|kali"
    ["Kali Linux 2024.4"]="kali|2024.4|kali2024|https://kali.download/cloud-images/kali-2024.4/kali-linux-2024.4-cloud-genericcloud-amd64.tar.xz|kali|kali|kali"
